...
export async function OurTeam() {
  const projectsData = await fetchServices(
    `${process.env.API_URL}/api/team-members?populate=*`,
    process.env.API_TOKEN
  );

  return (
    <>
            <h1 className="text-4xl sm:text-4xl md:text-4xl my-8 lg:text-5xl xl:text-6xl font-bold text-center mb-4 mt-24">Our Team</h1>

    <div className="md:w-[70vw] lg:w-[70vw] mb-28 mx-auto  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-12 place-items-center">
