    ...
    <HeroHighlight>
      <div className="mt-[26vh] mb-[1vh]">
        <motion.h1
          ...
          className="h-[70vh] text-2xl px-4 md:text-3xl lg:text-4xl font- text-neutral-700 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto "
        >
